...
class TelephoneCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Telephone::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/telephone');
        CRUD::setEntityNameStrings('telephone', 'telephones');
    ...
    {
        CRUD::setValidation(TelephoneRequest::class);
